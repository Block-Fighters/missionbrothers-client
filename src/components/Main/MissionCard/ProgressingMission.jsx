...
import progressingMissionData from './ProgressingMissionData';

function ProgressingMission() {
  ...
  const fetchMoreMission = async () => {
    ...
    try {
      const fetchData = progressingMissionData[page];
...
export default ProgressingMission;
